...
namespace MusiBuy.Admin.Controllers
{
    public class ResetPasswordController : Controller
    {
        ...
        public ResetPasswordController(IResetPassword resetPassword, IUser user)
        {
        ...
        public ActionResult Index(ResetPasswordViewModel resetPasswordViewModel)
        {
            if (ModelState.IsValid && !string.IsNullOrWhiteSpace(resetPasswordViewModel.Password))
            {
                ...
                UserViewModel objValidateUser = _userRepository.GetUserDetailsByID(resetPasswordViewModel.UserId);
