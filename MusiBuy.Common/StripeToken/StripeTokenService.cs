...
namespace MusiBuy.Common.StripeToken
{
    public class StripeTokenService
    {
        ...
        public StripeTokenService(IConfiguration config, ITokenPlans planrepo)
        {
            _config = config;
            _Planrepo = planrepo;
        }
        ...
        public string CreateTokenCheckoutSession_test(int planId,int UserId)
        {
            var domain = "https://f5wqrm9f-44359.inc1.devtunnels.ms/";
                ...
                LineItems = new List<SessionLineItemOptions>
            {
                ...
                Mode = "payment",
                SuccessUrl = $"{domain}/payment/success?planId={planId}",
