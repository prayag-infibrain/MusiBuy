    ...
    public class CommonSettingController : Controller
    {
        ...
        public ActionResult Edit(CommonSettingViewModel commonSettingViewModel)
        {
            ...
            {               
                ...
                if (tbl != null)
                {
                    bool isUpdated= _commonsettingRepository.UpdateCommonSettings(commonSettingViewModel, CurrentUserSession.User.UserID);
                    if (isUpdated) {
                ...
                {
                    bool isAdded=_commonsettingRepository.AddCommonSettings(commonSettingViewModel, CurrentUserSession.User.UserID);
                    if (isAdded)
                    {
