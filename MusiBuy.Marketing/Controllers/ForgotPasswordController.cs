...
namespace MusiBuy.Marketing.Controllers
{
    public class ForgotPasswordController : Controller
    {
        ...
        public ForgotPasswordController(IMarketingUser user, ITemplate template, ICommonSetting commonSetting, IConfiguration config)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (userData != null && !string.IsNullOrWhiteSpace(userData.Email))
                {
                    ...
                    if (template.TemplateContent != null)
                    {
                        ...
                        emailBody = PopulateEmailBody( userData, emailBody, commonSetting.MarktingSiteURL ?? string.Empty);
        ...
        private string PopulateEmailBody(MarketingUserViewModel userViewModel, string emailBody, string siteUrl)
        {
